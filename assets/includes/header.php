...
<head>
    ...
    <meta name="description" content="ZZAZ Solutions is a leading app and web development company offering innovative solutions for businesses. Contact us for customized app development and web design services.">
    <meta name="keywords" content="app development, web development, custom apps, web design">
        ...
        <div class="navbar d-block d-lg-none py-3 dynamic">
            <div class="container-fluid">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
                    <span><img class="w-75" src="assets/images/toggler.png" alt=""></span>
                </button>
