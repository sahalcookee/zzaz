...
?>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p class="font-poppins fw-normal para-black">Mobile app development requires the right blend of technology and resources. ZAZZ Solutions develops apps that are customized and best fit our client demands. The cost of a mobile app varies according to the features, resources, type, & time involved.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        <h6 class="font-poppins fw-normal primary-blue fs-6">Why choose ZAZZ for your mobile app development?</h6>
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        <h6 class="font-poppins fw-normal primary-blue fs-6">Does ZAZZ develop on-demand mobile apps?</h6>
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                        <h6 class="font-poppins fw-normal primary-blue fs-6">Does ZAZZ offer support or maintenance post-delivery?</h6>
                                    </button>
                                </h2>
    ...
    <script>
        window.addEventListener('DOMContentLoaded', function() {
            var newTitle = "ZAZZ Solutions | About Us.";
