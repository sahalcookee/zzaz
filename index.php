...
?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div>
                        ...
                        <p class="font-poppins fw-normal light-blue pb-4">At ZAZZ Solutions , we're passionate about developing innovative software solutions that help our clients succeed in today's rapidly evolving digital landscape. Our team of experienced developers, designers, and project managers work together to create custom software applications that are tailored to meet the specific needs of each of our clients.</p>
                        ...
                        <div class="row g-2 position-absolute h-s2-ttlcard">
                            <div class="col-lg-6 col-md-6">
                                <div class="rounded rounded-2 h-s2-card-div d-flex align-items-center justify-content-center p-3 text-center">
                                    ...
                                    <p class="font-poppins fw-normal primary-blue m-0 h-s2-card-p">ZAZZ serves the legitimate truth and service. No false promises are given. We give our word on the things we are able to do.</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="rounded rounded-2 h-s2-card-div d-flex align-items-center justify-content-center p-3 text-center">
    ...
    <!-- javascript -->
        ...
        window.addEventListener('DOMContentLoaded', function() {
            var newTitle = "ZAZZ Solutions | Empowering Growth Through Innovative Software Solutions";
